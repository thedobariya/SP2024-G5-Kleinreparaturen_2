image:https://github.com/HOME-programming-lab/SP2024-G5-Kleinreparaturen/actions/workflows/build.yml/badge.svg["CI Build", link="https://github.com/HOME-programming-lab/SP2024-G5-Kleinreparaturen/actions"]

= SP2024-G5-Kleinreparaturen (hier sollte zukünftig Ihr Projektname stehen)
